...
if(isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true){
   ...
   $(document).ready(function(){
	...
	<?php 
				$search = $_GET['search'];
				echo '<p style="margin-left:10px;font-size:25px;color:#000;">Results for "' .$search. ' "</p>';
				...
				while($row = mysqli_fetch_array($result)){
					...
					echo "<p style='padding-left:20px;font-size:18px;color:#808080;text-align:center;'> No results found</p>";
				}
