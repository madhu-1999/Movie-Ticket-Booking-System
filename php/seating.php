...
<head>
   ...
   <style type="text/css">
      ...
      header .fa-chevron-left{ color: #fff;}
      header a{color:#fff;}
      header{ padding:20px;background-color: #001b66; color: #fff;width:97%;}
      .front{width: 800px;margin: 5px 32px 45px 32px;background-color: #f0f0f0; color: #666;text-align: center;padding: 3px;border-radius: 5px;} 
      .booking-details {float: right;position: relative;width:350px;height: 450px;margin-top:30px;  } 
      .booking-details p{line-height:26px; font-size:16px; color:#999} 
      .booking-details p span{color:#666} 
      .checkout-button {display: block;width:180px; height:40px; margin: 10px auto;border:1px solid #666;font-size: 14px; cursor:pointer;background-color:#001b66;color:#fff;} 
      .checkout-button:hover{background-color: #001b88;}
      div.seatCharts-cell {color: #182C4E;height: 25px;width: 25px;line-height: 25px;margin: 7px;float: left;text-align: center;outline: none;font-size: 13px;}   
      div.seatCharts-seat {color: #fff;cursor: pointer;-webkit-border-radius: 5px;-moz-border-radius: 5px;border-radius: 5px;}
      div.seatCharts-row {height: 35px;margin: 5px;}
      div.seatCharts-seat.available {background-color: #fff; color: #000;}
      div.seatCharts-seat.focused {background-color: #001b66;border: none;}
      div.seatCharts-seat.selected {background-color: #001b88;}
      div.seatCharts-seat.unavailable {background-color: #818181;color:#000;cursor: not-allowed;}
      div.seatCharts-container {border-right:1px dotted #adadad;width: 850px;padding: 20px;float: left;}
      div.seatCharts-legend {padding-left: 0px;position: relative;bottom: 16px;}
      ul.seatCharts-legendList {padding-left: 0px;background-color: #f0f0f0;}
      .seatCharts-legendItem{ width:50px;margin-top: 10px; line-height:2;display:inline-table;}
      ...
      div.seatCharts-seat.available.platinum {  background-color: #3fe0D0;}
      div.seatCharts-seat.available.gold {  background-color: #b0dfe5;}
      div.seatCharts-seat.available.silver {  background-color: #588bae;}
         ...
         if (this.status() == 'available') { //optional seat
            ...
            return 'selected';
               ...
               let uncheck = this.settings.id;
                booked_seats = booked_seats.filter(function(e) { return e !== uncheck})
                console.log(booked_seats);
               //optional
               return 'available';
